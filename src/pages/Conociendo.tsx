  ...
  return (
    ...
    >
      ...
      <Typography marginBottom={2} color={"#7DDFCC"} paragraph>
        Dispóngase a conocer un pequeño ecosistema de los muchos que conforman
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <Box
          ...
          onClick={() => navigate("/conocimiento/ubicacion")}
        >
          <Box>
            <Typography variant="subtitle2">Próximo</Typography>
            <Typography variant="subtitle1">Ubicanión</Typography>
          </Box>
