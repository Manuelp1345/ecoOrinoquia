  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex" }}>
        ...
        >
          <Box>
            <Typography variant="subtitle1">Fundación EcoOrinoquia</Typography>
          </Box>
        </Box>
        <Box
          className="btnContent"
        ...
        >
          <Box>
            <Typography variant="subtitle1">Desarrolladores</Typography>
          </Box>
        </Box>
      </Box>
      <Box sx={{ display: "flex", mb: 5 }}>
        ...
        >
          <Box>
            <Typography variant="subtitle1">Patrocinantes y aliados</Typography>
          </Box>
        </Box>
      </Box>
