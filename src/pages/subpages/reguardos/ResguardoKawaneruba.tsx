      ...
      >
        ...
        >
          ...
          >
            ...
            <Box sx={{ width: "50%" }}>Kawaneruba</Box>
          </Box>
          <Box
            sx={{
              marginTop: 2,
        ...
        <Typography sx={{ fontWeight: "bold", mt: 2 }}>
          Fuente: Plan de Vida resguardo Kawaneruba.
        </Typography>
      </Box>
      <Box
        sx={{
...
export default ResguardoKawaneruba;
