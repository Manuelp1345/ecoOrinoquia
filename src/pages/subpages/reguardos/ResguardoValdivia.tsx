  ...
  return (
    ...
    >
      ...
      <Box
        ...
        component={"img"}
        src={"/img/RESGUARDO VALDIVIA.png"}
      />
      ...
      >
        ...
        >
          ...
          >
            ...
            <Box sx={{ width: "50%" }}>
              Se encuentra en medio del centro poblado de la catorce y la
              inspección de tres matas. Se encuentra al oriente de la inspección
              de tres matas y al occidente del casco urbano de Cumaribo.
            </Box>
          </Box>
          <Box
            sx={{
          ...
          >
            ...
            <Box sx={{ width: "50%" }}>3.870 Ha. 5.810 M2</Box>
          </Box>
          <Box
            sx={{
              marginTop: 2,
          ...
          >
            ...
            <Box sx={{ width: "50%" }}>271 pobladores y 60 familias. </Box>
          </Box>
          <Box
            sx={{
              marginTop: 2,
        ...
        <Typography sx={{ fontWeight: "bold", mt: 2 }}>
          Fuente: Plan de Vida resguardo Valdivia.
        </Typography>
      </Box>
      <Box
        sx={{
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <Box
          ...
          onClick={() => navigate("/conocimiento/reguardo/punta-bandera")}
        >
          <Box>
            <Typography variant="subtitle2">Próximo</Typography>
            <Typography variant="subtitle1">Resguardo Punta Bandera</Typography>
          </Box>
...
export default ResguardoValdivia;
